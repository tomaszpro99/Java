...
public class FileZipper extends JFrame
{
    public FileZipper()
    {
        ...
        //Nasza klasa akcja
        Action akcjaDodawania = new Akcja("Dodaj", "Dodaj nowy wpis do archiwum", "ctrl D", new ImageIcon("A13ZipperDodaj/dodaj.png"));
        Action akcjaUsuwania = new Akcja("Usuń", "Usuń zaznaczony/zaznaczone wpisy z archiwum", "ctrl U", new ImageIcon("A13ZipperDodaj/usun.png"));
    ...
    private class Akcja extends AbstractAction
    {
        ...
        private void dodajWpisyDoArchiwum() {
            wybieracz.setCurrentDirectory(new File(System.getProperty("user.dir")+File.separator+"A13ZipperDodaj")); //odpalamy nowe okno wyboru
